const PROBIDHAN_2022_DATA = {
  ...
  'computer': {
    ...
    semesters: {
      '1st Semester': [
        { sl: 1, subject: 'Computer Office Application', code: '26611' },
        { sl: 2, subject: 'Engineering Drawing', code: '21011' },
        { sl: 3, subject: 'English-I', code: '25712' },
        { sl: 4, subject: 'Mathematics-I', code: '25911' },
        { sl: 5, subject: 'Physics-I', code: '25912' },
        { sl: 6, subject: 'Bangla-I', code: '25711' },
      ...
      '2nd Semester': [
        ...
        { sl: 7, subject: 'Computer Graphic Design-I', code: '28522' },
  ...
  'civil': {
    ...
    semesters: {
      ...
      '6th Semester': [
        ...
        { sl: 6, subject: 'Advance Construction', code: '28861' },
        { sl: 7, subject: 'Environmental Studies', code: '29041' }
      ],
      '7th Semester': [
        { sl: 1, subject: 'Principle of Marketing', code: '25851' },
  ...
  'electrical': {
    deptName: 'Electrical Technology (Diploma)',
    probidhan: 'Probidhan 2022',
    semesters: {
      '1st Semester': [
        { sl: 1, subject: 'Engineering Drawing', code: '21011' },
        { sl: 2, subject: 'Bangla-I', code: '25711' },
        { sl: 3, subject: 'English-I', code: '25712' },
        { sl: 4, subject: 'Physical Education & Life Skill Development', code: '25812' },
        { sl: 5, subject: 'Mathematics-I', code: '25911' },
      ...
      '3rd Semester': [
        ...
        { sl: 3, subject: 'Computer Office Applications', code: '28511' },
      ...
      '5th Semester': [
        ...
        { sl: 6, subject: 'Electrical Engineering Projects-II', code: '26754' },
  ...
  'electronics': {
    ...
    semesters: {
      ...
      '2nd Semester': [
        ...
        { sl: 5, subject: 'Chemistry', code: '25913' },
        { sl: 6, subject: 'Mathematics-II', code: '25921' },
        { sl: 7, subject: 'Electrical Circuits-I', code: '26721' },
        { sl: 8, subject: 'Electronic Devices and Circuits', code: '26821' }
      ],
      '3rd Semester': [
        ...
        { sl: 4, subject: 'Electrical Circuits-II', code: '26731' },
        { sl: 5, subject: 'Digital Electronics-I', code: '26831' },
        { sl: 6, subject: 'Power Electronics', code: '26832' }
      ],
      '4th Semester': [
        { sl: 1, subject: 'Accounting', code: '25841' },
        { sl: 2, subject: 'Electrical Installation, Planning and Estimating', code: '26741' },
        { sl: 3, subject: 'DC Machine', code: '26742' },
        { sl: 4, subject: 'Digital Electronics-II', code: '26841' },
        { sl: 5, subject: 'Communication Engineering', code: '26842' },
        { sl: 6, subject: 'Networks, Filters and Transmission Lines', code: '26843' },
        { sl: 7, subject: 'Electronic Servicing', code: '26844' }
      ],
      '5th Semester': [
        { sl: 1, subject: 'Principles of Marketing', code: '25851' },
        { sl: 2, subject: 'Industrial Management', code: '25852' },
        { sl: 3, subject: 'Programming in C', code: '28567' },
        { sl: 4, subject: 'Generation of Electrical Power', code: '26751' },
        { sl: 5, subject: 'Electrical & Electronic Measurements-I', code: '26752' },
        { sl: 6, subject: 'Television Engineering', code: '26851' },
        { sl: 7, subject: 'Electronic Appliances', code: '26852' },
        { sl: 8, subject: 'Bio-Medical Instruments', code: '28654' }
      ],
      '6th Semester': [
        { sl: 1, subject: 'AC Machine-I', code: '26761' },
        { sl: 2, subject: 'Transmission and Distribution of Electrical Power', code: '26764' },
        { sl: 3, subject: 'Electrical & Electronic Measurements-II', code: '26763' },
        { sl: 4, subject: 'TV Studio and Broadcasting', code: '26861' },
        { sl: 5, subject: 'Microcontroller and Embedded System', code: '26862' },
        { sl: 6, subject: 'PCB Design and Prototyping', code: '26863' },
        { sl: 7, subject: 'Environmental Studies', code: '29041' }
      ],
      '7th Semester': [
        { sl: 1, subject: 'Business Communication', code: '25831' },
        { sl: 2, subject: 'Innovation & Entrepreneurship', code: '25853' },
        { sl: 3, subject: 'AC Machine-II', code: '26771' },
        { sl: 4, subject: 'Microwave Radar and Navigation Aids', code: '26871' },
        { sl: 5, subject: 'Industrial Automation and PLC', code: '26872' },
        { sl: 6, subject: 'Control System and Robotics', code: '26873' },
        { sl: 7, subject: 'Electronic Project', code: '26874' }
      ],
      '8th Semester': [
        { sl: 1, subject: 'Industrial Attachment & Project Presentation', code: '26881' }
      ]
    }
  },
  ...
  'mechanical': {
    deptName: 'Mechanical Technology (Diploma)',
    probidhan: 'Probidhan 2022',
    semesters: {
      '1st Semester': [
        { sl: 1, subject: 'Engineering Drawing', code: '21011' },
      ...
      '7th Semester': [
        ...
        { sl: 5, subject: 'Mechanical Engineering Projects', code: '27074' },
  ...
  'power': {
    ...
    semesters: {
      ...
      '8th Semester': [
        ...
        { sl: 2, subject: 'Project Presentation & Defense', code: '27181' }
      ]
    }
  },
  ...
  'telecom': {
    ...
    semesters: {
      ...
      '8th Semester': [
        ...
        { sl: 2, subject: 'Project Presentation & Defense', code: '26781' }
      ]
    }
  }
};
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Intercept section switching in teacher dashboard
  const _originalShowSection = window.showSection;
  window.showSection = function(section, event) {
    const newSections = ['quiz-create', 'books-manage', 'cr-manage', 'msg-inbox', 'complaint-view'];
    if (newSections.includes(section)) {
      ...
      const contentArea = document.getElementById('contentArea') || document.querySelector('.main-content');
      loadTeacherNewSection(section, contentArea);
    } else if (_originalShowSection) {
      _originalShowSection(section, event);
    }
  };
  ...
  if (teacherEmail) {
    checkTeacherBadges();
    setInterval(checkTeacherBadges, 60000);
  }
});

function loadTeacherNewSection(section, contentArea) {
  const tpl = document.getElementById(`tpl-${section}`);
  if (!tpl || !contentArea) return;

  let wrapper = document.getElementById(`t-section-${section}`);
  if (!wrapper) {
    wrapper = document.createElement('div');
    wrapper.id = `t-section-${section}`;
    wrapper.setAttribute('data-tsection', section);
  ...
  contentArea.querySelectorAll(':scope > div:not([id^="t-section-"])').forEach(el => el.style.display = 'none');
  ...
  switch (section) {
    case 'quiz-create':
      quizQuestionCount = 0;
      addQuizQuestion(); // Add first default question
      loadTeacherQuizzes();
      break;
    case 'books-manage':
      loadTeacherBooks();
    ...
    case 'cr-manage':
      loadStudentsForCR();
      loadTeacherCRs();
      // Initialize group dropdown for default semester (1st)
  ...
  try {
    const res = await fetch(`${TEACHER_API}/quiz/create/`, {
      ...
      body: JSON.stringify({
        ...
        title, subject, semester, language,
...
async function addBook() {
  const semester = document.getElementById('bookSem')?.value;
  const subject_name = document.getElementById('bookSubName')?.value?.trim();
  const subject_code = document.getElementById('bookCode')?.value?.trim();
...
function loadTeacherBooks(isUserClick) {
  ...
  if (!deptVal || !semVal) {
    if (isUserClick) {
      alert('Please select both Department and Semester to view the book list.');
    } else {
      container.innerHTML = `
  ...
  try {
    ...
    if (data.status === 'success') {
      ...
      sel.innerHTML = `<option value="">-- Select Student (${students.length} found) --</option>` +
        students.map(s => `<option value="${s.id}">${s.name || 'Unnamed'} (Roll: ${s.roll || '--'}, Sem: ${s.semester || '--'})</option>`).join('');
      if (!students.length) sel.innerHTML = '<option value="">No students found</option>';
    }
  } catch (e) {}
}
  ...
  try {
    ...
    if (data.status === 'success' && data.data.length) {
      container.innerHTML = data.data.map(cr => {
        ...
        return `
          <div style="background:var(--card); border:${isPending ? '1px solid rgba(245,158,11,0.4)' : '1px solid var(--border)'}; border-radius:14px; padding:18px;">
    ...
    if (data.status === 'success' && data.data.length) {
      container.innerHTML = data.data.map(m => `
        <div style="background:var(--card);border:1px solid var(--border);border-radius:14px;padding:18px">
          ...
          ${m.replies.map(r => `
            <div style="margin-left:16px;border-left:3px solid #6c8fff;padding:8px 12px;background:var(--card2);border-radius:0 8px 8px 0;margin-bottom:6px;font-size:13px">
...
// ============================================================
// COMPLAINTS MANAGEMENT (Teacher sees student name & roll)
// ============================================================
...
async function checkTeacherBadges() {
  try {
    ...
    if (msgBadge && data.status === 'success') {
      msgBadge.style.display = data.unread_count > 0 ? 'inline-block' : 'none';
    ...
    if (cBadge && cData.status === 'success') {
      const pending = cData.data.filter(c => !c.is_resolved).length;
      cBadge.style.display = pending > 0 ? 'inline-block' : 'none';
